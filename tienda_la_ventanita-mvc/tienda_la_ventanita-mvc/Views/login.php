...
<div class="login-card">
  ...
  <!-- RUTA CORREGIDA -->
  <form action="/tienda_la_ventanita-mvc/index.php?action=doLogin" method="POST">
  ...
  <!-- ESTE ESTÁ PERFECTO -->
  <a href="/tienda_la_ventanita-mvc/index.php?action=insertUser" class="btn btn-success w-100 mt-3">
      Registrar Usuario
  </a>
